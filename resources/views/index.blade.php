      ...
      <div class="hero-content">
        ...
        <div class="hero-actions">
          ...
          <div style="display:inline-flex;gap:0.5rem;align-items:center;">
            <a href="{{ asset('Meghana_Acharya_Resume.pdf') }}" target="_blank" class="btn btn-accent btn-sm" style="padding:0.7rem 1.2rem;">
              <i class="fas fa-eye"></i> View Resume
            </a>
            <a href="{{ asset('Meghana_Acharya_Resume.pdf') }}" download class="btn btn-outline btn-sm" style="padding:0.7rem 1.2rem;">
